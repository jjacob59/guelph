...
resume = TRUE  # if you need to re-start after a crash, flip this to True
exp = "53"  # experiment number
gpu = "3"
lr = "0.001"
momentum = "0.97"
decay = "0.0001"
...
freeze = {"white":1,"opaque":2,"gray":2,"shmoo":2,"pseudohyphae":3,"hyphae":3}
