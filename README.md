...
CANDESCENCE: this points to the root of the directories downloaded.
VARASANA: this points to the Varasana dataset within CANDESCENCE. That is. VARSANA = CANDESCENCE + "/varasana"
ROOT: the file path to this repo on your machine
OUTPUT: which is usually a subfolder of CANDESCENCE. e.g. CANDESCENCE + "/output" ... This stores all the data generated by an MMDECTION  run.
PERFORMANCE: This stores all the generated analyses of the performance of the classifier described in OUTPUT. Usually defined as CANDESCENCE + "/performance"
TOOL: this points to the MMDETECTION executable.
